    ...
    return (
        <View style={{
            ...
            <View style={{ flexDirection: 'row', width: windowWidth - 150, justifyContent: 'space-between', right: 20 }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ fontSize: 16, color: GlobalStyles[theme].fontColor, fontFamily: GlobalFontStyles[fontStyle].fontStyle }}>{userContext ? userContext?.followers?.length : userInfo?.profile?.followers?.length}</Text>
                ...
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ fontSize: 16, color: GlobalStyles[theme].fontColor, fontFamily: GlobalFontStyles[fontStyle].fontStyle }}>{userContext ? userContext?.following?.length : userInfo?.profile?.following?.length}</Text>
